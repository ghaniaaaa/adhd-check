			...
			<div class="menu">
				<a href="index.html" >
					<div class="logo d-flex align-items-center">
						<img src="{{ asset('landing/img/logo-adhd.png') }}" alt="Logo ADHD Check" />
    					<span>ADHD Check</span>
					</div>
				</a>
				<ul>
					<li>
		...
		<main>
								...
								<div class="row">
									<div class="col-md-12 full-height mob-height mx-3">	
										...
										<div class="hero-center-wrap z-bigger">
											<h1 class="parallax-fade-top">Cek Tingkat <br><span>ADHD-mu </span></h1> 
										</div>
										<p class="hero-top-text">ADHD-mu</p>
									</div>	
								</div>
							</div>	
						</div>
							...
							<div class="container text-left">
								<div class="row">
									<div class="col-md-12 full-height mob-height mx-3">	
										...
										<div class="hero-center-wrap z-bigger">
											<h1 class="parallax-fade-top">Pahami <br><span>Kondisimu</span></h1>
										</div>
			...
			<div class="section footer padding-top-big background-image-cover" style="background-image: url(img/footer.jpg);">	
				<div class="container">
					<div class="row">
						<div class="col-md-12">	
							<img src="landing/img/logo-adhd.png" alt="logo image"/>
						</div>	
